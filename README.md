...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-7xos29o.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-7xos29o.containers.anotherwebservice.com/
...
```
git clone git@github.com:rufailimantawa/container-7xos29o.git
cd container-7xos29o
```
...
```
docker attach container-7xos29o
```
